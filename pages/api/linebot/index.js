import { linebotApi } from '@util/api';
        ...
        switch (event.message.text) {
          ...
          case 'Picture':
            event.reply({
              type: 'image',
              originalContentUrl:
                'https://d.line-scdn.net/stf/line-lp/family/en-US/190X190_line_me.png',
              previewImageUrl:
                'https://d.line-scdn.net/stf/line-lp/family/en-US/190X190_line_me.png',
            });
            break;
          case 'Location':
            ...
            break;
          case 'Push':
            bot.push('U17448c796a01b715d293c34810985a4c', [
              'Hey!',
              'สวัสดี ' + String.fromCharCode(0xd83d, 0xde01),
            ]);
            break;
          case 'Push2':
          ...
          case 'Multicast':
            bot.push(
              [
                'U17448c796a01b715d293c34810985a4c',
                'Cba71ba25dafbd6a1472c655fe22979e2',
              ],
              'Multicast!'
            );
            break;
